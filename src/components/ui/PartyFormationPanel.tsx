    ...
    >
      ...
      {hero && heroState ? (
        <div className="text-center">
          ...
          {/* Remove button - 44px touch target with visual 20px circle */}
          <button
            onClick={(e) => {
              e.stopPropagation();
              onRemove();
          ...
          >
            <span className="w-5 h-5 bg-red-500 hover:bg-red-600 text-white rounded-full text-xs flex items-center justify-center shadow transition-colors">
              ×
            </span>
          </button>
        </div>
